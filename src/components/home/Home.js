    ...
    >
      <div className="container flex flex-col mx-2 mt-16">
        <div className="flex-col md:flex-row-reverse md:p-10 flex sm:flex-col-reverse sm:pt-[150px]">
          ...
          <div className="w-full flex flex-col m-auto md:bg-transparent absolute top-40 md:top-0 mb-40 h-screen md:h-52 md:relative mx-4 mb:mx-8 sm:mx-0">
            <h1 
            ...
            <h1 className="text-white text-[33px] mb:text-5xl sm:text-5xl lg:text-5xl capital w-[220px] mb:w-[320px] sm:w-[360px] lg:w-[460px] leading-tight font-semibold">
