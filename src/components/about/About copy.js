    ...
    >
      <div className="flex flex-col-reverse md:flex-row mx-10 justify-between items-center py-20">
        ...
        <div className="w-[30%] relative">
          <div className="mt-5 md:mt-0 h-56 w-56 md:h-70 md:w-70">
            <img
          ...
          <div>
            <span className="absolute bottom-3 -right-20 bg-slate-900 p-3 px-3 z-10 flex rounded-lg items-center space-x-2">
              <img
